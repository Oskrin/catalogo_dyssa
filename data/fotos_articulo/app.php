<?php 
	...
	//activar articulos
	if (isset($_POST['activar_articulo'])) {
		$resultado = $class->consulta("UPDATE productos SET estado = '1' WHERE id = '$_POST[id]'");
	...
	//activar articulos
	if (isset($_POST['pasivo_articulo'])) {
		$resultado = $class->consulta("UPDATE productos SET estado = '0' WHERE id = '$_POST[id]'");
