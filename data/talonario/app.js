app.controller('talonarioController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        ...
	        datatype: "xml",
			height: 330,
			colNames:['ID','FECHA INICIO','FECHA CADUCIDAD','INICIO TALONARIO','FIN TALONARIO','AUTORIZACIÓN','FECHA CREACIÓN'],
			colModel:[
	            ...
	            {name:'inicio_talonario',index:'inicio_talonario',width:'', editable:true, search:false, editrules: {required: true}, editoptions:{maxlength: 30, dataInit: function(elem){$(elem).bind("keypress", function(e) {return ValidNum(e)})}}},
	            {name:'finaliza_talonario',index:'finaliza_talonario',width:'', editable:true, search:false, editrules: {required: true}, editoptions:{maxlength: 30, dataInit: function(elem){$(elem).bind("keypress", function(e) {return ValidNum(e)})}}},
	            {name:'autorizacion',index:'autorizacion',width:'', editable:true, search:false, editrules: {required: true}, editoptions:{maxlength: 30, dataInit: function(elem){$(elem).bind("keypress", function(e) {return ValidNum(e)})}}},
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2') {
                	...
                	if(retorno == '3') {
                		$("#autorizacion").val("");
	                	return [false,"Error.. La Autorización ya fue Agregada"];
	                }
                }
                return [true,'',retorno];
            },
	    },
	    {
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '1') {
                	...
                	if(retorno == '3') {
                		$("#autorizacion").val("");
	                	rreturn [false,"Error.. La Autorización ya fue Agregada"];
	                }
                }
                return [true,'',retorno];
            },
	    ...
	    function style_edit_form(form) {
	        ...
	        form.find('input[name=fecha_caducidad]').datepicker({format:'yyyy-mm-dd' , autoclose:true})
