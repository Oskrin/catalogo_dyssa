<?php
    ...
    class PDF extends FPDF {   
        ...
        function Header() {             
            ...
            $this->Cell(150, 5, utf8_decode("EXISTENCIA MÍNIMA"), 0,1, 'R', 0);      
            $this->SetFont('Arial','B',16);                                                    
            $this->Cell(190, 8, "EMPRESA: ".$_SESSION['empresa']['actividad_economica'], 0,1, 'C',0);                                
            $this->Image('logo_empresa.jpg',1,8,40,30);
            $this->SetFont('Amble-Regular','',10);        
            $this->Cell(180, 5, "PROPIETARIO: ".utf8_decode($_SESSION['empresa']['nombre_comercial']),0,1, 'C',0);                                
            ...
            $this->Cell(170, 5, "DIR.: ".utf8_decode($_SESSION['empresa']['direccion_matriz']),0,1, 'C',0);                                
    ...
    $pdf->SetX(5);
    $resultado = $class->consulta("SELECT codigo, codigo_barras, descripcion, precio_minorista, precio_mayorista, stock,stock_minimo FROM productos WHERE estado = '1' AND stock::integer < stock_minimo::integer ORDER BY id");
