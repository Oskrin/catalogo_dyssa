...
app.config(function($routeProvider) {
    ...
    // route dias
    .when('/dias', {
        templateUrl : 'data/dias/index.html',
    ...
    // route directores
    .when('/directores', {
        templateUrl : 'data/directores/index.html',
        controller  : 'directoresController',
    ...
    .when('/devolucion_venta', {
        templateUrl : 'data/devolucion_venta/index.html',
        controller  : 'devolucion_ventaController',
        activetab: 'devolucion_venta'
    })
    ...
    // proceso repositorio
    .when('/repositorio', {
        templateUrl : 'data/repositorio/index.html',
...
app.run(function ($rootScope, $location, Auth, loginService, $window) {
    ...
    $rootScope.$on('$routeChangeStart', function (event) {
        ...
        //     var conectar = loginService.islogged();
        //     conectar.then(function(msg) {
        //         if (!msg.data)        $window.location = 'login';
        //     });
...
app.factory('sessionService', function($http, $location) {
    return {
        ...
        destroy: function(key) {
            $http.post('login/destroy_session.php')
...
app.factory('loginService', function($http, $location, sessionService, $window) {
    return {
        ...
        islogged: function() {
            ...
            // if (sessionService.get('id_usuario')) return true;
        }    
    }
});
