app.controller('clientesController', function ($scope, $route) {
	...
	jQuery(function($) {
		...
		jQuery(function($) {
		    ...
		    jQuery(grid_selector).jqGrid({	        
		        ...
		        colNames: ['ID','TIPO DOCUMENTO','IDENTIFICACIÓN','NOMBRES COMPLETOS','TELÉFONO','CELULAR','CIUDAD','DIRECCIÓN','CORREO'],
		        colModel:[      
