...
<html ng-app="scotchApp" lang="es">
	<head>
		...
		<!-- controlador procesos angular -->
  		...
  		<script src="data/dias/app.js"></script>
  		<script src="data/facturero/app.js"></script>
  		<script src="data/talonario/app.js"></script>
  		...
  		<script src="data/directores/app.js"></script>
  		...
  		<script src="data/repositorio/app.js"></script>
  		...
  		<script src="data/devolucion_venta/app.js"></script>
		...
		<div class="main-container" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive">
				...
				<ul class="nav nav-list">
					...
					<li ng-class = "{'active open':
												$route.current.activetab == 'dias' ||
												$route.current.activetab == 'talonario' ||
						...
						<ul class="submenu">
							<li ng-class="{active: $route.current.activetab == 'dias'}">
								<a href="#/dias">
									<i class="menu-icon fa fa-caret-right"></i>
									Activar Días
								</a>
							...
							<li ng-class="{active: $route.current.activetab == 'talonario'}">
								<a href="#/talonario">
									<i class="menu-icon fa fa-caret-right"></i>
									Talonario Retenciones
								</a>
					...
					<li ng-class = "{'active open':
												$route.current.activetab == 'directores' || 
						...
						<ul class="submenu">
							<li ng-class="{active: $route.current.activetab == 'directores'}">
								<a href="#/directores" class="dropdown-toggle">
									<i class="menu-icon fa fa-caret-right"></i>
									Registro Directores
								</a>
								<b class="arrow"></b>
					...
					<li ng-class = "{'active open': 
												...
												$route.current.activetab == 'devolucion_venta'
									}">
						<a href="" class="dropdown-toggle">
							<i class="menu-icon fa fa-shopping-cart"></i>
							<span class="menu-text">
						...
						<ul class="submenu">
							...
							<li ng-class="{active: $route.current.activetab == 'devolucion_venta'}">
								<a href="#/devolucion_venta">
									<i class="menu-icon fa fa-caret-right"></i>
									Devolución Venta 
								</a>
								<b class="arrow"></b>
					...
					<li ng-class = "{'active open': 
												$route.current.activetab == 'repositorio'
									}">
						<a href="" class="dropdown-toggle">
						...
						<ul class="submenu">
							...
							<li ng-class="{active: $route.current.activetab == 'repositorio'}">
								<a href="#/repositorio">
									<i class="menu-icon fa fa-caret-right"></i>
									Nuevo Repositorio
								</a>
